// pages/account/record/record.js
...
Page({
  ...
  integral: function (pageIndex, pageSize) {
    wx.showToast({
      title: '正在加载',
      icon: 'loading',
      duration: 10000
    ...
    var that = this;
    wx.request({
      url: apiHost.api_domain + '/' + apiHost.api_name + '/member/integralRecord',
      header: {
      ...
      success: function (res) {
        ...
        if (code == 200) {
          ...
          setTimeout(function () {
            var url = '../record/record'   //  /page/ 表示打开新的页面
  ...
  onReachBottom: function () {
    if (this.data.totalPage > this.data.pageIndex) {
      ...
      this.integral(pageIndex, pageSize)
    }
  },
